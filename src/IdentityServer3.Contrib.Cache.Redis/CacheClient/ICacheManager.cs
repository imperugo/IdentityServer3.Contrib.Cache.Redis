...
namespace IdentityServer3.Contrib.Cache.Redis.CacheClient
{
    ...
    public interface ICacheManager
    {
        ...
        /// <summary>
        /// Cache the object for 30 minuts
        /// </summary>
        /// <typeparam name="T"></typeparam>
        /// <param name="cacheKey"></param>
        /// <param name="getData"></param>
        /// <returns></returns>
        T GetAndFill<T>(string cacheKey, Func<T> getData);
        ...
        /// <param name="getData"></param>
        /// <returns></returns>
        Task<T> GetAndFillAsync<T>(string cacheKey, Func<Task<T>> getData);
        ...
        /// <returns></returns>
        T GetAndFill<T>(string cacheKey, Func<T> getData, TimeSpan expiration);
        ...
        /// <param name="expiration"></param>
        /// <returns></returns>
        Task<T> GetAndFillAsync<T>(string cacheKey, Func<Task<T>> getData, TimeSpan expiration);
